defmodule Register.Accounts.User do
  ...
  schema "users" do
    ...
    has_many :taught_courses, through: [:lecturer_courses, :course]
  ...
  defp maybe_validate_unique_email(changeset, opts) do
    if Keyword.get(opts, :validate_email, true) do
      changeset
      |> unsafe_validate_unique(:email, Register.Repo)
  ...
  """
  def valid_password?(%Register.Accounts.User{hashed_password: hashed_password}, password)
