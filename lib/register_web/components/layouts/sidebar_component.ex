            ...
            <nav class="mt-5 flex-1 px-2 space-y-1">
              ...
              <div class="mb-4">
                ...
                <div class="mt-2 space-y-1">
                  ...
                  <.nav_link to="/Admin/library" icon="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" active={String.starts_with?(@current_path, "/Admin/library")}>
                    Online Library
                  </.nav_link>
              ...
              <% :student -> %>
                <!-- Student links -->
                  ...
                  <.nav_link to="/Students/otp-management" icon="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" active={@current_path == "/Students/enter-register-otp"}>
                   ...
                   <.nav_link to="/Students/library" icon="M9 5H7a2 2 0 00-2 2v10a2 2 0 002 2h8a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4" active={@current_path == "/Students/library"}>
                    Online Library
                  </.nav_link>
              ...
              <% :lecturer -> %>
                  ...
                  <.nav_link to="/Lecturer/library" icon="M9 5H7a2 2 0 00-2 2v10a2 2 0 002 2h8a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4" active={@current_path == "/Lecturer/library"}>
                    Online Library
                  </.nav_link>
