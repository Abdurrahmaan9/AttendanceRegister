          ...
          <div class="flex-1 flex flex-col pt-5 pb-4 overflow-y-auto">
            ...
            <nav class="mt-5 flex-1 px-2 space-y-1">
              ...
              <div class="mb-4">
                ...
                <% :student -> %>
                  <!-- Student links -->
                  <.nav_link to="/Students/attendance/view" icon="M15 12a3 3 0 11-6 0 3 3 0 016 0z M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" active={@current_path == "/Students/attendance/view"}>
                    Attendance View
                  </.nav_link>
