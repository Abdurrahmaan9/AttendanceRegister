defmodule RegisterWeb.CoreComponents do
  @moduledoc """
    ...
    <div
      ...
      class={
        [
          ...
          @kind == :info && "bg-emerald-50 text-emerald-800 shadow-md ring-emerald-500 fill-cyan-900",
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(RegisterWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(RegisterWeb.Gettext, "errors", msg, opts)
    end
  end
