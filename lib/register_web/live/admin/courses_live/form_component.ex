          ...
          >
            <div class="grid grid-cols-6 gap-6">
              <div class="col-span-6 sm:col-span-3">
                <label for="course_title" class="block text-sm font-medium text-gray-700">Title</label>
                <.input
                  field={f[:title]}
                  type="text"
                  label="Title"
              ...
              <div class="col-span-6 sm:col-span-3">
                <label for="course_code" class="block text-sm font-medium text-gray-700">Code</label>
                <.input
                  field={f[:code]}
                  type="text"
                  label="Code"
              ...
              <div class="col-span-6 sm:col-span-3">
                <label for="course_credits" class="block text-sm font-medium text-gray-700">Credits</label>
                <.input
                  field={f[:credits]}
                  type="number"
                  label="Credits"
